    ...
    <main class="app-shell d-flex align-items-center justify-content-center">
        <section class="form-card glass-panel p-4 p-md-5">
            <div class="mb-4">
                ...
                <h1 class="section-title h2 mb-1">Ajouter un livre</h1>
                <p class="muted-text mb-0">Completez les informations de l'ouvrage.</p>
            </div>

            <form action="<?= base_url('/insertionlivre') ?>" method="post">
                <div class="mb-3">
